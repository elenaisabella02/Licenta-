              ...
              <div class="carousel-inner">
                <div class="carousel-item active" data-bs-interval="10000">
                  <div class="card card-testimonials">
                      <div class="card-body">
                        <h5 class="card-title">Sabrina Craiu</h5>
                        <p class="card-text card-testimonials-margin">„În trecut am avut tangențe foarte mici cu limbajul C++, dar nu credeam că parcurgerea acestui curs îmi va schimba părerea despre programare într-un mod radical. Sub îndrumarea oamenilor potriviți totul este simplu.”</p>
                      </div>
                    </div>
                </div>
                <div class="carousel-item" data-bs-interval="2000">
                  <div class="card card-testimonials">
                      <div class="card-body">
                        <h5 class="card-title">Marian Ioan</h5>
                        <p class="card-text card-testimonials-margin">„Limbajul C# era foarte puțin cunoscut pentru mine, dar l-am îndrăgit după finalizarea cursului. Mentorii mi-au fost aproape la fiecare pas și m-au făcut să îmi doresc să continui pe acest drum în continuare.”</p>
                      </div>
                    </div>
                </div>
                <div class="carousel-item">
                  <div class="card card-testimonials">
                      <div class="card-body">
                        <h5 class="card-title">Patricia Mitu</h5>
                        <p class="card-text card-testimonials-margin">"Cursul a fost o mare schimbare pentru mine, dar l-am parcurs pentru o reorientare în carieră. Totul a fost extraordinar de bine structurat, de la materie și până la interacțiunea noastră cu mentorii, care ne-au ajutat la fiecare pas."</p>
                      </div>
                    </div>
