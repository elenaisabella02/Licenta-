                    ...
                    <li class="nav-item px-3">
                      ...
                      <li class="nav-item dropdown px-3">
                        ...
                        <ul class="dropdown-menu" aria-labelledby="navbarDropdown">
                          <li><a class="dropdown-item active" href="#">Front-End Developer</a></li>
        ...
        <div class="despre-curs py-5">
            <div class="card mb-3 py-5">
                ...
                <div class="col-md-6">
                    ...
                    <p class="card-text">Cursul de Front-End Developer ne introduce în bazele web-design-ului și se bazează pe partea vizuală a unui site web. Această parte ne lasă frâu liber imaginației, ne permite să ne jucăm foarte mult cu ceea ce învățăm și ne ajută să le oferim utilizatorilor cea mai plăcută experiență pe care o pot avea atunci când folosesc motoarele de căutare. Principalele tehnologii pe care ne bazăm sunt HTML, CSS, și Javascript. Vom învăța să ne jucăm cu așezarea în pagină, adăugarea de efecte vizuale, astfel încât produsul final pe care noi îl livrăm să fie cât mai interactiv și plăcut vizual, deoarece cu toții am avut măcar un site de care nu am fost mulțumiți din punct de vedere al aspectului sau al complexității lui.</p>
              ...
              <div class="carousel-inner">
                <div class="carousel-item active" data-bs-interval="10000">
                  <div class="card card-testimonials">
                      <div class="card-body">
                        <h5 class="card-title">Ioana Gherman</h5>
                        <p class="card-text card-testimonials-margin">„Cursul de Front-End a fost ceea ce aveam nevoie pentru a mă decide ce mi-aș dori să fac pentru tot restul vieții mele, lucru pe care l-am realizat cu ajutorul dăruinței pe care mentorii mi-au oferit-o în tot parcursul.”</p>
                      </div>
                    </div>
                </div>
                <div class="carousel-item" data-bs-interval="2000">
                  <div class="card card-testimonials">
                      <div class="card-body">
                        <h5 class="card-title">Matei Chirilă</h5>
                        <p class="card-text card-testimonials-margin">„Un curs extrem de ajutător, nu numai pentru cei aflați la început de drum, care este predat de oameni care te inspiră prin plăcerea cu care explică toate noțiunile și le fac să pară extrem de simple.”</p>
                      </div>
                    </div>
                </div>
                <div class="carousel-item">
                  <div class="card card-testimonials">
                      <div class="card-body">
                        <h5 class="card-title">Elena Maftei</h5>
                        <p class="card-text card-testimonials-margin">"Trainerii ne oferă mult suport, ne demonstrează că niciodată nu e prea târziu să faci ceva, asta dacă o faci cu pasiune, așa cum am descoperit la fiecare dintre ei, deoarece am avut foarte multe de învățat."</p>
                      </div>
                    </div>
