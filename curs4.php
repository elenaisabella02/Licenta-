                    ...
                    <li class="nav-item px-3">
                      ...
                      <li class="nav-item dropdown px-3">
                        ...
                        <ul class="dropdown-menu" aria-labelledby="navbarDropdown">
                          ...
                          <li><a class="dropdown-item active" href="#">Java</a></li>
              ...
              <div class="carousel-inner">
                <div class="carousel-item active" data-bs-interval="10000">
                  <div class="card card-testimonials">
                      <div class="card-body">
                        <h5 class="card-title">Marie Alexandrescu</h5>
                        <p class="card-text card-testimonials-margin">„Limbajul Java este un limbaj extrem de flexibil, lucru pe care l-am înțeles după finalizarea acestui curs, sub îndrumarea mentorilor care s-au ocupat îndeaproape de fiecare dintre noi.”</p>
                      </div>
                    </div>
                </div>
                <div class="carousel-item" data-bs-interval="2000">
                  <div class="card card-testimonials">
                      <div class="card-body">
                        <h5 class="card-title">Matias Mihai</h5>
                        <p class="card-text card-testimonials-margin">„Parcursul meu în academie a fost unul uimitor. Pot spune că am venit fără așteptări, dar am plecat cu un bagaj de cunoștințe și cunoscând niște oameni care mi-au inspirat pasiunea lor.”</p>
                      </div>
                    </div>
                </div>
                <div class="carousel-item">
                  <div class="card card-testimonials">
                      <div class="card-body">
                        <h5 class="card-title">Paul Anisiei</h5>
                        <p class="card-text card-testimonials-margin">"Cursul de Java a adus o îmbunătățire enormă pentru mine. Inițial am încercat să învăț singur, dar nu am avut parte de progrese într-un an cât am avut alături de academie în trei luni."</p>
                      </div>
                    </div>
